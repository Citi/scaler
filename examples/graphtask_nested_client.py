...
def fibonacci(clnt: Client, n: int):
    if n == 0:
        ...
        # BE WARNED! You are not suppose to use it like that.
        # This is to demonstrate the ability instead of intention of what
        # graph can do. This should rarely be done. Redesign if you find
        # yourself in this position.
        # With the ability to dynamically build a graph, one can even
        # concatenate the source graph to its child (as long as they evaluate
        # to a value).
