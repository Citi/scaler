...
from scaler.io.model import ConnectorType, IoContext, Address, Connector
...
class AsyncBinder(Looper, Reporter):
    ...
    def __init__(self, session: IoContext, name: str, address: Address, identity: bytes | None = None) -> None:
        if identity is None:
