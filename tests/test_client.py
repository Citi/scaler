...
class TestClient(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._workers = 3
        self._workers_queue_sizes = [10, 100, 1000]
        self.cluster = SchedulerClusterCombo(address=self.address, n_workers=self._workers, workers_queue_sizes=self._workers_queue_sizes, event_loop="builtin")
