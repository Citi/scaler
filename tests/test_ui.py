...
class TestUI(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._workers = 10
        self.cluster = SchedulerClusterCombo(address=self.address, n_workers=self._workers, workers_queue_sizes=[10 for _ in range(0, self._workers)], event_loop="builtin")
