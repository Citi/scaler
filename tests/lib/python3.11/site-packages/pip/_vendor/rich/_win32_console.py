...
class LegacyWindowsTerm:
    ...
    ANSI_TO_WINDOWS = [
        ...
        4,  # red                         @timeout_decorator.timeout(LOCAL_TIMEOUT)
    define FOREGROUND_BLUE            0x0001 -- 0000 0001
        2,  # green                       @timeout_decorator.timeout(LOCAL_TIMEOUT)
    define FOREGROUND_GREEN           0x0002 -- 0000 0010
        6,  # yellow                      @timeout_decorator.timeout(LOCAL_TIMEOUT)
    define FOREGROUND_RED             0x0004 -- 0000 0100
        1,  # blue                        @timeout_decorator.timeout(LOCAL_TIMEOUT)
    define FOREGROUND_INTENSITY       0x0008 -- 0000 1000
        5,  # magenta                     @timeout_decorator.timeout(LOCAL_TIMEOUT)
    define BACKGROUND_BLUE            0x0010 -- 0001 0000
        3,  # cyan                        @timeout_decorator.timeout(LOCAL_TIMEOUT)
    define BACKGROUND_GREEN           0x0020 -- 0010 0000
        7,  # white                       @timeout_decorator.timeout(LOCAL_TIMEOUT)
    define BACKGROUND_RED             0x0040 -- 0100 0000
        8,  # bright black (grey)         @timeout_decorator.timeout(LOCAL_TIMEOUT)
